...
# For input data
data_train_dir      =  './../12_group_mel/data_train/'
data_test_dir       =  './../11_mel/data_test/'   #no group for test data
data_pre_train_dir  =  './../11_mel/data_train/'   #no group for test data
