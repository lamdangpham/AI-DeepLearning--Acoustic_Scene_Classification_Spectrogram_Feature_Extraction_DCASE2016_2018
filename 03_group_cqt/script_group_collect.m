% For saving TODO
mkdir('./../12_group_cqt');
mkdir('./../12_group_cqt/data_train');
mkdir('./../12_group_cqt/data_test');
opts.save_train_dir = './../12_group_cqt/data_train/';
opts.save_test_dir  = './../12_group_cqt/data_test/';

% For input data TODO
opts.train_dir  =  '../11_cqt/data_train/';
opts.test_dir   =  '../11_cqt/data_test/';
