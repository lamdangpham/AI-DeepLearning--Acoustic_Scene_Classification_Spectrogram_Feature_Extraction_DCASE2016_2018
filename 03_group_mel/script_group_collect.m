% For saving TODO
mkdir('./../12_group_mel');
mkdir('./../12_group_mel/data_train');
mkdir('./../12_group_mel/data_test');
opts.save_train_dir = './../12_group_mel/data_train/';
opts.save_test_dir  = './../12_group_mel/data_test/';

% For input data TODO
opts.train_dir  =  '../11_mel/data_train/';
opts.test_dir   =  '../11_mel/data_test/';
